...
## UML
![Graphic UML](uml.gif) (Graphic generated by [Pynsource](https://pynsource.com/), discovered through [StackOverflow](https://stackoverflow.com/questions/260165/whats-the-best-way-to-generate-a-uml-diagram-from-python-source-code)).
